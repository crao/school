  ...
  <div class="content-wrapper">
    <!-- Content Header (Page header) -->
	  ...
	  <div class="row" style="margin-left:5px;margin-right:5px;">
		...
		<div style="text-align: center"> <h3>Return Library Books </h3></div> <p> 
		 <p/>&nbsp;<p/>
		...
		<div class="container-fluid form-group"><!-- Row 4 -->
			...
			<div class="col-lg-6" id="userFormColumn7">
				...
				<div class="form-group">
					...
					$result = $crud->getData("SELECT * FROM library_book WHERE accessionNumber	 = '$accessionNumber' ORDER BY srno Asc");
					...
					foreach ($result as $res) {
						  ...
						  $staffStudentId1 = $res['staff_stu_Id'];	
						  $fullName1 = $res['fullName'];	
						  $section1 = $res['section'];		
						  $class1 = $res['class'];		
		...
		<th style="border: 1px solid #FFFFFF;background: #3c8dbc;color: #FFFFFF;text-align: center; ">Issue Return</th>
			...
			<?php	  
				...
				echo '<td style="padding: 1px;border: 1PX solid #FFFFFF;background: #B0C4DE ;text-align:center;">' . $fullName1 . '</td>';
				echo '<td style="padding: 1px;border: 1PX solid #FFFFFF;background: #B0C4DE ;text-align:center;">' . $section1 . '</td>';
				...
				echo '<td style="padding: 1px;border: 1PX solid #FFFFFF;background: #B0C4DE; text-align:center;"><input type="submit"  value="Return" name="SubmitReturnBook" class="btn btn-primary" /></td>'; 
