...
<div class="wrapper">
  ...
  <div class="content-wrapper" align="center">
    <!-- Content Header (Page header) -->
	  ...
	  <h3 style="margin-left:20px;text-align:center;">View Library Report</h3> 
 ...
 <li class="selected" id="page1" onclick="change_tab(this.id);">Available Books</li>
 <li class="notselected" id="page2" onclick="change_tab(this.id);">Issueed Books</li>
 <li class="notselected" id="page3" onclick="change_tab(this.id);">Library Books Report</li>
 ...
 <div class='hidden_desc' id="page1_desc">
  ...
  <div class="container" align="center">
		<form class="form-inline" role="form"  action="viewlibrary.php" method="post">
...
<p><br/>
		...
		$query = "Select * from library_book WHERE category='$category' and fullName = ''";
		
		$rows = $crud->getNorows($query);
		
		
		$result = $crud->getData("SELECT * FROM library_book WHERE category='$category' and fullName = ''  Order by srno Desc ");
		...
		<th style="border: 1px solid #FFFFFF;background: #3C8DBC;color: #FFFFFF;text-align: center; ">Author Name</th> 
		...
		<th style="border: 1px solid #FFFFFF;background: #3C8DBC;color: #FFFFFF;text-align: center; ">Book Number</th>
		<th style="border: 1px solid #FFFFFF;background: #3C8DBC;color: #FFFFFF;text-align: center; ">Year of Publication</th>
		<th style="border: 1px solid #FFFFFF;background: #3C8DBC;color: #FFFFFF;text-align: center; ">Book Pages</th>
		<th style="border: 1px solid #FFFFFF;background: #3C8DBC;color: #FFFFFF;text-align: center; ">Book Cost</th>
		<th style="border: 1px solid #FFFFFF;background: #3C8DBC;color: #FFFFFF;text-align: center; ">Publication</th>
		<th style="border: 1px solid #FFFFFF;background: #3C8DBC;color: #FFFFFF;text-align: center; ">Library Shelf</th>
			...
			foreach ($result as $res) {
				  ...
				  $yearofPublication=$res['yearofPublication'];
				...
				echo '<td style="padding: 1px;border: 1PX solid #FFFFFF;background: #B0C4DE ;">' . $yearofPublication . '</td>';
				echo '<td style="padding: 1px;border: 1PX solid #FFFFFF;background: #B0C4DE ;">' . $bookPages . '</td>';
				echo '<td style="padding: 1px;border: 1PX solid #FFFFFF;background: #B0C4DE ;">' . $bookCost . '</td>';			
...
<p><br>
	<table width="400" cellspacing="2" cellpadding="2" align="center">
		...
		$query = "Select count(*) As Total from library_book WHERE category='$category' and fullName = ''";
		...
		$result = mysqli_query($conn, "Select count(*) As Total from library_book WHERE category='$category' and fullName = ''");
		...
		echo "<span><a id='page_a_link' href='viewlibrary.php?page=$j'>&nbsp;&nbsp;< Prev&nbsp;&nbsp;</a></span>";
		...
		echo "<span><a id='page_a_link' href='viewlibrary.php?page=$i'>&nbsp;&nbsp;$i&nbsp;&nbsp;</a></span>";
		...
		echo "<span><a id='page_a_link' href='viewlibrary.php?page=$j'>&nbsp;&nbsp;Next >&nbsp;&nbsp;</a></span>";
 ...
 <div class='hidden_desc' id="page2_desc">
  ...
  <div class="form-group">
      <?php	
					...
					?>
	  <input type="submit" value="Submit" name="SubmitIssueed" class="btn btn-primary"> 
	  <input type="submit" value="Reset" name="Reset" class="btn btn-primary">
    </div>
   </form>
  </div>
...
<p><br/>
		...
		<th style="border: 1px solid #FFFFFF;background: #3C8DBC;color: #FFFFFF;text-align: center; ">Category</th> 
		<th style="border: 1px solid #FFFFFF;background: #3C8DBC;color: #FFFFFF;text-align: center; ">Book Number</th>
		<th style="border: 1px solid #FFFFFF;background: #3C8DBC;color: #FFFFFF;text-align: center; ">Full Name</th>
		...
		<th style="border: 1px solid #FFFFFF;background: #3C8DBC;color: #FFFFFF;text-align: center; ">Issue Date</th>
		<th style="border: 1px solid #FFFFFF;background: #3C8DBC;color: #FFFFFF;text-align: center; ">Due Date</th>
			...
			foreach ($result as $res) {
				...
				echo '<td style="padding: 1px;border: 1PX solid #FFFFFF;background: #B0C4DE ;">' . $bookType . '</td>';
				echo '<td style="padding: 1px;border: 1PX solid #FFFFFF;background: #B0C4DE ;">' . $category . '</td>';
				echo '<td style="padding: 1px;border: 1PX solid #FFFFFF;background: #B0C4DE ;text-align:center;">' . $accessionNumber . '</td>';
				echo '<td style="padding: 1px;border: 1PX solid #FFFFFF;background: #B0C4DE ;">' . $fullName . '</td>';
				echo '<td style="padding: 1px;border: 1PX solid #FFFFFF;background: #B0C4DE ;">' . $staff_stu_Id . '</td>';
				echo '<td style="padding: 1px;border: 1PX solid #FFFFFF;background: #B0C4DE ;">' . $section . '</td>';			
				echo '<td style="padding: 1px;border: 1PX solid #FFFFFF;background: #B0C4DE ;">' . $issue_date . '</td>';
				echo '<td style="padding: 1px;border: 1PX solid #FFFFFF;background: #B0C4DE ;">' . $due_date . '</td>';			
 ...
 <div class='hidden_desc' id="page3_desc">
  ...
  <div class="form-group">
      <?php	
					...
					?>
	  <input type="submit" value="Submit" name="SubmitLibraryReport" class="btn btn-primary"> 
	  <input type="submit" value="Reset" name="Reset" class="btn btn-primary">
    </div>
   </form>
  </div>
...
<p><br/>
		...
		if(isset($_POST['SubmitLibraryReport'])) {
		include_once("classes/Crud.php");
		...
		$query = "Select * from library_book_issue WHERE category='$category' and return_date != ''";
		
		$rows = $crud->getNorows($query);
		
		
		$result = $crud->getData("SELECT * FROM library_book_issue WHERE category='$category' and return_date != '' Order by srno Desc");
		...
		<th style="border: 1px solid #FFFFFF;background: #3C8DBC;color: #FFFFFF;text-align: center; ">Category</th> 
		<th style="border: 1px solid #FFFFFF;background: #3C8DBC;color: #FFFFFF;text-align: center; ">Book Number</th>
		<th style="border: 1px solid #FFFFFF;background: #3C8DBC;color: #FFFFFF;text-align: center; ">Staff / Student ID</th>
		<th style="border: 1px solid #FFFFFF;background: #3C8DBC;color: #FFFFFF;text-align: center; ">Full Name</th>
		<th style="border: 1px solid #FFFFFF;background: #3C8DBC;color: #FFFFFF;text-align: center; ">Section</th>
		<th style="border: 1px solid #FFFFFF;background: #3C8DBC;color: #FFFFFF;text-align: center; ">Issue Date</th>
		<th style="border: 1px solid #FFFFFF;background: #3C8DBC;color: #FFFFFF;text-align: center; ">Return Date</th>
		<th style="border: 1px solid #FFFFFF;background: #3C8DBC;color: #FFFFFF;text-align: center; ">Fine</th>
			...
			foreach ($result as $res) {
				...
				echo '<td style="padding: 1px;border: 1PX solid #FFFFFF;background: #B0C4DE ;">' . $section . '</td>';			
				echo '<td style="padding: 1px;border: 1PX solid #FFFFFF;background: #B0C4DE ;">' . $issue_date . '</td>';
				echo '<td style="padding: 1px;border: 1PX solid #FFFFFF;background: #B0C4DE ;">' . $return_date . '</td>';			
				echo '<td style="padding: 1px;border: 1PX solid #FFFFFF;background: #B0C4DE ;">' . $fine . '</td>';			
...
<p><br>
	<table width="400" cellspacing="2" cellpadding="2" align="center">
		...
		$query = "Select count(*) As Total  library_book_issue WHERE category='$category' and return_date != '' ";
		...
		$result = mysqli_query($conn, "Select count(*) As Total library_book_issue WHERE category='$category' and return_date != '' ");
