  ...
  <div class="content-wrapper">
    <!-- Content Header (Page header) -->
	  ...
	  <div class="row" style="margin-left:1px;margin-right:1px;">
		...
		<div style="text-align: center"> <h3>Staff Presenty Report</h3></div> <p> 
		 <p/>&nbsp;<p/>
          <form action="viewpresentystaff.php" method="post">
		...
		<div class="container-fluid form-group"><!-- Row 4 -->
			...
			<div class="col-lg-6" id="userFormColumn7">
				...
				<div class="form-group">
					<div class="col-sm-3"><label for="class">Department</label></div>
					<div class="col-sm-6">
					<?php	
					$result = $crud->getData("SELECT * FROM   staff_add GROUP BY department");
			...
			<div class="col-lg-6" id="userFormColumn8">
				...
				<div class="form-group">
				   <div class="col-sm-3"> <label for="Gender">Select Division</label></div>
					...
					<?php	
					$result = $crud->getData("SELECT * FROM  staff_add GROUP BY section");
		...
		<div class="container-fluid form-group"><!-- Row Last -->
			...
			<div class="col-lg-12" id="studentSubmit">
				...
				<div class="form-group">
					...
					<div class="col-sm-4"><input type="submit"  value="Submit" name="SubmitPresenty" class="btn btn-primary" /></div>
	...
	//	if(isset($_POST['SubmitPresenty'])) { 
		...
		$query = "Select * from staff_attendance WHERE department = '$department' AND attDate BETWEEN  '$startDate' AND '$endDate'";
		
		$rows = $crud->getNorows($query); 
		
		
		$result = $crud->getData("SELECT * FROM staff_attendance  WHERE department = '$department' AND attDate BETWEEN  '$startDate' AND '$endDate' Order by srnoAtt Asc");
		...
		<th style="border: 1px solid #FFFFFF;background: #3c8dbc;color: #FFFFFF;text-align: center; ">Working Days</th> 
		<th style="border: 1px solid #FFFFFF;background: #3c8dbc;color: #FFFFFF;text-align: center; ">Present Days</th>
		<th style="border: 1px solid #FFFFFF;background: #3c8dbc;color: #FFFFFF;text-align: center; ">Department</th>		
		<th style="border: 1px solid #FFFFFF;background: #3c8dbc;color: #FFFFFF;text-align: center; ">Division</th> 
		<th style="border: 1px solid #FFFFFF;background: #3c8dbc;color: #FFFFFF;text-align: center; ">Staff Name</th>
		<th style="border: 1px solid #FFFFFF;background: #3c8dbc;color: #FFFFFF;text-align: center; ">Attendance %</th>
			...
			foreach ($result as $res) {
                ...
                echo '<td style="padding: 1px;border: 1PX solid #FFFFFF;background: #B0C4DE ;">' . $attDate . '</td>';
                echo '<td style="padding: 1px;border: 1PX solid #FFFFFF;background: #B0C4DE ;text-align: center;">' . $workingDays . '</td>';
				echo '<td style="padding: 1px;border: 1PX solid #FFFFFF;background: #B0C4DE ;text-align: center;">' . $attendance . '</td>';
				echo '<td style="padding: 1px;border: 1PX solid #FFFFFF;background: #B0C4DE ;text-align: center;">' . $department . '</td>';
				...
				echo '<td style="padding: 1px;border: 1PX solid #FFFFFF;background: #B0C4DE ; text-align: center;">' . $percentage . '</td>';
	...
	<table width="400" cellspacing="2" cellpadding="2" align="center">
		...
		$query = "Select count(*) As Total from stu_attendance WHERE  fullName = '$studentName' AND attDate BETWEEN  '$startDate' AND '$endDate' ";
		...
		$result = mysqli_query($conn, "Select count(*) As Total from stu_attendance WHERE  fullName = '$studentName' AND attDate BETWEEN  '$startDate' AND '$endDate'");
		...
		echo "<span><a id='page_a_link' href='viewstupresenty.php?page=$j'>&nbsp;&nbsp;< Prev&nbsp;&nbsp;</a></span>";
		...
		echo "<span><a id='page_a_link' href='viewstupresenty.php?page=$i'>&nbsp;&nbsp;$i&nbsp;&nbsp;</a></span>";
		...
		echo "<span><a id='page_a_link' href='viewstupresenty.php?page=$j'>&nbsp;&nbsp;Next >&nbsp;&nbsp;</a></span>";
