...
<div class="wrapper">
  ...
  <div class="content-wrapper" align="center">
    <!-- Content Header (Page header) -->
	  ...
	  <h3 style="margin-left:20px;text-align:center;">View Timetable</h3> 
	  
        
	<p></br>	
	<div class="container" align="center">
	<form class="form-inline" role="form"  action="viewtimetable.php" method="post">
    ...
    <div class="form-group">
     <div class="container-fluid form-group"><!-- Row 7 -->
	  ...
	  <input type="submit" value="Reset" name="Reset" class="btn btn-primary"> 
		...
		$query = "Select * from staff_timetable Group by  section";
		
		$rows = $crud->getNorows($query);
		
		
		$result = $crud->getData("SELECT * FROM staff_timetable Group by  section Order by srno Asc Limit $start, $perpage");
		
		$chooseClass = $_POST['chooseClass'];
		$section = $_POST['section'];
		
		if (!empty($chooseClass)) {
		...
		$query = "Select * from staff_timetable  Group by  section WHERE chooseClass='$chooseClass' Group by  section";
		
		$rows = $crud->getNorows($query);
		
		
		$result = $crud->getData("SELECT * FROM staff_timetable WHERE chooseClass='$chooseClass'  Group by  section  Order by srno Asc Limit $start, $perpage");
		...
		$query = "Select * from staff_timetable  WHERE section='$section' Group by  section";
		
		$rows = $crud->getNorows($query);
		
		
		$result = $crud->getData("SELECT * FROM staff_timetable WHERE section='$section'  Group by  section Order by srno Asc Limit $start, $perpage");
		...
		<th style="border: 1px solid #FFFFFF;background: #3c8dbc;color: #FFFFFF;text-align: center; ">&nbsp; Class / Standard </th> 
		...
		<th style="border: 1px solid #FFFFFF;background: #3c8dbc;color: #FFFFFF;text-align: center; ">&nbsp;Update User</th>
			...
			foreach ($result as $res) {
				...
				echo '<td style="padding: 1px;border: 1PX solid #FFFFFF;background: #B0C4DE; text-align:center;"><a align href="crud/viewpopuptimetable.php?id=' . $id . '" id="btnShow">View</a></td>';
				
				echo '<td style="padding: 1px;border: 1PX solid #FFFFFF;background: #B0C4DE; text-align:center;"><a align href="updatetimetable.php?id=' . $id . '">Update</a></td>'; 
  ...
  <!-- /.content-wrapper -->
	...
	<table width="400" cellspacing="2" cellpadding="2" align="center">
		...
		$query = "Select count(*) As Total from staff_timetable Group by  section";
		...
		$result = mysqli_query($conn, "Select count(*) As Total from staff_timetable Group by  section");
		...
		echo "<span><a id='page_a_link' href='viewtimetable.php?page=$j'>&nbsp;&nbsp;< Prev&nbsp;&nbsp;</a></span>";
		...
		echo "<span><a id='page_a_link' href='viewtimetable.php?page=$i'>&nbsp;&nbsp;$i&nbsp;&nbsp;</a></span>";
		...
		echo "<span><a id='page_a_link' href='viewtimetable.php?page=$j'>&nbsp;&nbsp;Next >&nbsp;&nbsp;</a></span>";
