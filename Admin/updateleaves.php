  ...
  <div class="content-wrapper">
    <!-- Content Header (Page header) -->
	  ...
	  <div class="row" style="margin-left:5px;margin-right:5px;">
		...
		<div style="text-align: center"> <h3>School Leaves</h3></div> <p> 
		 <p/>&nbsp;<p/>
		 <?php
		  if (isset($_GET['id']) && is_numeric($_GET['id']) && $_GET['id'] > 0)
				...
				$result = $crud->getData("SELECT * FROM school_leaves WHERE srnoLeaves = '$id' Limit 1");
		...
		?>		
          ...
          <form action="crud/updateaddleaves.php" enctype="multipart/form-data" method="post">
		...
		<div class="container-fluid form-group"><!-- Row 2 -->
			...
			<div class="col-lg-6" id="userFormColumn3">
				...
				<div class="form-group">
					<div class="col-sm-3"><label for="Date">Start Date</label></div>
					<div class="col-sm-6">
					...
					<input type="text" name="startDate" class="form-control pull-right" id="datepicker" value="<?php echo $startDate;?>">
					</div>
			...
			<div class="col-lg-6" id="userFormColumn4">
				...
				<div class="form-group">
					<div class="col-sm-3"><label for="Date">End Date</label></div>
					<div class="col-sm-6">
					...
					<input type="text" name="endDate" class="form-control pull-right" id="datepicker1" value="<?php echo $endDate;?>">
					</div>
		...
		<div class="container-fluid form-group"><!-- Row 4 -->
			...
			<div class="col-lg-6" id="userFormColumn7">
				...
				<div class="form-group">
					<div class="col-sm-3"><label for="class">Select Division</label></div>
					<div class="col-sm-6">
					
					<?php	
					$result = $crud->getData("SELECT * FROM  stu_division");
					
					echo "<select onChange='fetch_select1(this.value);' name='section'  class='form-control detail'>"; ?>
			...
			<div class="col-lg-6" id="userFormColumn8">
				...
				<div class="form-group">
				   <div class="col-sm-3"> <label for="Gender">Student Name</label></div>
					<div class="col-sm-6">
						<?php 
		...
		<div class="col-lg-6" id="userFormColumn7">
				...
				<div class="form-group">
					<div class="col-sm-3"><label for="class">Reason for Leaves</label></div>
					<div class="col-sm-6">
					
					<?php	
										
					echo '<textarea name="reason" class="form-control detail">';?> <?php echo $reason;?>
		...
		<div class="container-fluid form-group"><!-- Row Last -->
			...
			<div class="col-lg-12" id="studentSubmit">
				...
				<div class="form-group">
					...
					<div class="col-sm-4"><input type="submit"  value="Submit" name="SubmitUpdateLeaves" class="btn btn-primary" /></div>
		...
		$query = "Select * from school_leaves ORDER BY srnoLeaves Desc";
		
		$rows = $crud->getNorows($query); 
		
		
		$result = $crud->getData("SELECT * FROM school_leaves  ORDER BY srnoLeaves Desc Limit $start, $perpage");
		...
		<th style="border: 1px solid #FFFFFF;background: #3c8dbc;color: #FFFFFF;text-align: center; ">Start Date</th> 
		<th style="border: 1px solid #FFFFFF;background: #3c8dbc;color: #FFFFFF;text-align: center; ">End Date</th> 
		<th style="border: 1px solid #FFFFFF;background: #3c8dbc;color: #FFFFFF;text-align: center; ">Number of Days</th> 
		...
		<th style="border: 1px solid #FFFFFF;background: #3c8dbc;color: #FFFFFF;text-align: center; ">Reason</th>
		...
		<th style="border: 1px solid #FFFFFF;background: #3c8dbc;color: #FFFFFF;text-align: center; ">Delete</th>
			...
			foreach ($result as $res) {
                ...
                echo '<td style="padding: 1px;border: 1PX solid #FFFFFF;background: #B0C4DE ;">' . $startDate . '</td>';
                echo '<td style="padding: 1px;border: 1PX solid #FFFFFF;background: #B0C4DE ;">' . $endDate . '</td>';
				echo '<td style="padding: 1px;border: 1PX solid #FFFFFF;background: #B0C4DE ;">' . $numberDays . '</td>';
				...
				echo '<td style="padding: 1px;border: 1PX solid #FFFFFF;background: #B0C4DE ;">' . $reason . '</td>';
				
				echo '<td style="padding: 1px;border: 1PX solid #FFFFFF;background: #B0C4DE; text-align:center;"><a align href="updateleaves.php?id=' . $id . '">Update</a></td>'; 
				
				echo '<td style="padding: 1px;border: 1PX solid #FFFFFF;background: #B0C4DE; text-align:center;"><a align href="crud/deleteleaves.php?id=' . $id . '" onclick="return confirmDelete()">Delete</a></td>';	
                echo "</tr>"; 
		...
		$query = "Select count(*) As Total from school_leaves ";
		...
		$result = mysqli_query($conn, "Select count(*) As Total from school_leaves");
		...
		echo "<span><a id='page_a_link' href='createleaves.php?page=$j'>&nbsp;&nbsp;< Prev&nbsp;&nbsp;</a></span>";
		...
		echo "<span><a id='page_a_link' href='createleaves.php?page=$i'>&nbsp;&nbsp;$i&nbsp;&nbsp;</a></span>";
		...
		echo "<span><a id='page_a_link' href='createleaves.php?page=$j'>&nbsp;&nbsp;Next >&nbsp;&nbsp;</a></span>";
