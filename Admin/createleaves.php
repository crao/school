  ...
  <div class="content-wrapper">
    <!-- Content Header (Page header) -->
	  ...
	  <div class="row" style="margin-left:1px;margin-right:1px;">
		...
		<div style="text-align: center"> <h3>Student Leaves</h3></div> <p> 
		 <p/>&nbsp;<p/>
          <form action="crud/addleaves.php" enctype="multipart/form-data" method="post">
		...
		<div class="container-fluid form-group"><!-- Row 4 -->
			...
			<div class="col-lg-6" id="userFormColumn8">
				...
				<div class="form-group">
				   <div class="col-sm-3"> <label for="Gender">Select Name</label></div>
					<div class="col-sm-6">
		...
		<div class="container-fluid form-group"><!-- Row 4 -->
			...
			<div class="col-lg-6" id="userFormColumn7">
				...
				<div class="form-group">
					...
					echo '<textarea type="text" name="reason" class="form-control detail" ></textarea>';
		...
		<div class="container-fluid form-group"><!-- Row Last -->
			...
			<div class="col-lg-12" id="studentSubmit">
				...
				<div class="form-group">
					...
					<div class="col-sm-4"><input type="submit"  value="Submit" name="SubmitLeaves" class="btn btn-primary" /></div>
