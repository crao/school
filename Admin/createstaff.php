      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu" style="background-color: #0073B7;">
            ...
            <li><a href="createbooks.php"><i class="fa fa-circle-o"></i> Add Library</a></li>
  ...
  <div class="content-wrapper">
    <!-- Content Header (Page header) -->
	  ...
	  <div class="row">
		...
		<div style="text-align: center"> <h3>Staff Enrollment</h3></div> <p> 
		 <p/>&nbsp;<p/>
          <form action="crud/addstaff.php" enctype="multipart/form-data" method="post">
			...
			<div class="col-lg-6" id="userFormColumn1" >		 
				...
				<div class="form-group">
				   <div class="col-sm-3"> <label for="studentId">Staff ID</label></div>
				   <div class="col-sm-6">
			...
			<div class="col-lg-6" id="userFormColumn2">
				...
				<div class="form-group">
				   <div class="col-sm-3"><label for="adm_date">Date of Joining</label></div>
					<div class="col-sm-6">
					...
					<input type="text" name="dateOfJoining" class="form-control pull-right" id="datepicker">
					</div>
			...
			<div class="col-lg-6" id="userFormColumn4">
				...
				<div class="form-group">
				   <div class="col-sm-3"> <label for="firstName">First Name</label></div>
					<div class="col-sm-6"><input name="firstName" id="firstName" required class="form-control" placeholder="Enter First Name"></div>
		...
		<div class="container-fluid form-group"><!-- Row 3 -->
			...
			<div class="col-lg-6" id="userFormColumn5">
				...
				<div class="form-group">
					...
					<div class="col-sm-6"><input name="middleName" id="middleName"  class="form-control" placeholder="Enter Middle Name"></div>
			...
			<div class="col-lg-6" id="userFormColumn6">
				...
				<div class="form-group">
				   <div class="col-sm-3"> <label for="lastName">Last Name</label></div>
					<div class="col-sm-6"><input name="lastName" id="lastName" required class="form-control" placeholder="Enter Last Name"></div>
		...
		<div class="container-fluid form-group"><!-- Row 5 -->
			...
			<div class="col-lg-6" id="userFormColumn7">
				...
				<div class="form-group">
					...
					<input type="hidden" class="form-control detail" name="MAX_FILE_SIZE" value="5342888" /> </div>
			...
			<div class="col-lg-6" id="userFormColumn8">
				...
				<div class="form-group">
				   <div class="col-sm-3"> <label for="dateOfBirth">Date Of Birth</label></div>
					...
					<input type="text" name="dateOfBirth" class="form-control pull-right" id="birthdate" placeholder='Date of Birth'>
					</div>
		...
		<div class="container-fluid form-group"><!-- Row 6 -->
			...
			<div class="col-lg-6" id="userFormColumn7">
				...
				<div class="form-group">
					<div class="col-sm-3"><label for="bloodGroup">Teaching Staff</label></div>
					<div class="col-sm-6"><input type="radio" id="Teaching" name="staff" value="Teaching" checked="checked">
         &nbsp; Teaching Staff &nbsp;&nbsp;&nbsp;  <p>
				</div>
			...
			<div class="col-lg-6" id="userFormColumn8">
				...
				<div class="form-group">
				   <div class="col-sm-3"> <label for="medicalHistory">Non-Teaching Staff</label></div>
					<div class="col-sm-6"><input type="radio" id="Non-Teaching" name="staff" value="NonTeaching" >
         &nbsp; Non - Teaching Staff &nbsp;&nbsp;&nbsp;
		...
		<div class="container-fluid form-group"><!-- Row 7 -->
			...
			<div class="col-lg-6" id="userFormColumn7">
				...
				<div class="form-group">
					<div class="col-sm-3"><label for="chooseClass">Department</label></div>
					<div class="col-sm-6">
				<?php	
					$result = $crud->getData("SELECT * FROM   staff_department");
						echo "<select name='department'  class='form-control detail'>";
						echo "<option>Select Deaprtment</option>";
						foreach ($result as $res) {
			...
			<div class="col-lg-6" id="userFormColumn8">
				...
				<div class="form-group">
				   <div class="col-sm-3"> <label for="Section">Post Applied For</label></div>
					<div class="col-sm-6">
					<input type="text" name="postApplied" class="form-control pull-right" required id="postApplied" placeholder='Post Applied'>
		...
		<div class="container-fluid form-group"><!-- Row 7 -->
			...
			<div class="col-lg-6" id="userFormColumn7">
				...
				<div class="form-group">
					<div class="col-sm-3"><label for="chooseClass">Choose Class</label>
		...
		<div class="container-fluid form-group"><!-- Row 9 -->
			...
			<div class="col-lg-6" id="userFormColumn7">
				...
				<div class="form-group">
					...
					<div class="col-sm-6"><input type="emailId" class="form-control" id="exampleInputEmail1" required name="emailId" placeholder="Enter email ID">  <p>
				</div>
			...
			<div class="col-lg-6" id="userFormColumn8">
				...
				<div class="form-group">
				   <div class="col-sm-3"> <label for="mobileNumber">Mobile Number</label></div>
					<div class="col-sm-6"><input name='mobileNumber' class='form-control detail' required type='text' placeholder='Enter Mobile Number'>
		...
		<div class="container-fluid form-group"><!-- Row 10 -->
			...
			<div class="col-lg-6" id="userFormColumn7">
				...
				<div class="form-group">
					...
					<div class="col-sm-6"><input type="text" class="form-control" readonly id="userName" name="userName" value="<?php echo $staffId;  ?>" > <p> 
				</div>
			...
			<div class="col-lg-6" id="userFormColumn8">
				...
				<div class="form-group">
				   <div class="col-sm-3"> <label for="userPassword">Password</label></div>
					<div class="col-sm-6"><input type="password" class="form-control" required id="exampleInputPassword1" name="userPassword" placeholder="Enter Password">
			...
			<div class="col-lg-6" id="userFormColumn8">
				...
				<div class="form-group">
				   <div class="col-sm-3"> <label for="documentDeposited">Documents Deposited</label></div>
					<div class="col-sm-6"><textarea type="text" class="form-control" required id="documentDeposited" name="documentDeposited" placeholder="Enter Documents Deposited"></textarea>
		...
		<div class="container-fluid form-group"><!-- Row 13 -->
			...
			<div class="col-lg-6" id="userFormColumn7">
				...
				<div class="form-group">
					<div class="col-sm-3"><label for="Religion">Previous Package</label></div>
					<div class="col-sm-6"><input type="text" class="form-control" id="prevPackage"  name="prevPackage" placeholder="Enter Previous Package">  <p>
				</div>
			...
			<div class="col-lg-6" id="userFormColumn8">
				...
				<div class="form-group">
				   <div class="col-sm-3"> <label for="Caste">Current Package</label></div>
					<div class="col-sm-6"><input name='currentPackage' class='form-control detail' type='text' placeholder='Enter Current Package'>
		...
		<div class="container-fluid form-group"><!-- Row 13 -->
			...
			<div class="col-lg-6" id="userFormColumn7">
				...
				<div class="form-group">
					...
					<div class="col-sm-6"><input type="text" class="form-control" id="Religion"  name="religion" placeholder="Enter Religion">  <p>
				</div>
		...
		<div class="container-fluid form-group"><!-- Row 14 -->
			...
			<div class="col-lg-6" id="userFormColumn7">
				...
				<div class="form-group">
					...
					<div class="col-sm-6"><input type="text" class="form-control" id="subCaste" name="subCaste" placeholder="Enter Sub Caste">  <p>
				</div>
		...
		<div class="container-fluid form-group"><!-- Row 15 -->
			...
			<div class="col-lg-6" id="userFormColumn7">
				...
				<div class="form-group">
					<div class="col-sm-3"><label for="staffAddress">Address</label></div>
					<div class="col-sm-6"><input type="text" class="form-control" id="staffAddress" required  name="staffAddress" placeholder="Enter Address">  <p>
				</div>
			...
			<div class="col-lg-6" id="userFormColumn8">
				...
				<div class="form-group">
				   <div class="col-sm-3"> <label for="country">City</label></div>
					<div class="col-sm-6"><input name='city' class='form-control detail' type='text' placeholder='Enter Country'>
		...
		<div class="container-fluid form-group"><!-- Row 17 -->
			...
			<div class="col-lg-6" id="userFormColumn7">
				...
				<div class="form-group">
					...
					<div class="col-sm-6"><input type="text" class="form-control" id="residanceNumber"  name="residanceNumber" placeholder="Enter Residance Number">  <p>
				</div>
			...
			<div class="col-lg-6" id="userFormColumn8">
				...
				<div class="form-group">
				   <div class="col-sm-3"> <label for="mobSms">Mobile Number</label></div>
					<div class="col-sm-6"><input name='mobSms' id="mobsms" class='form-control detail' type='text' placeholder='Enter Mobile Number'><br>
		...
		<div class="container-fluid form-group"><!-- Row 19 -->
			...
			<div class="col-lg-6" id="userFormColumn7">
				...
				<div class="form-group">
					<div class="col-sm-3"><label for="prevYearPass">Remarks</label></div>
					<div class="col-sm-6">
			...
			<div class="col-lg-6" id="userFormColumn8">
				...
				<div class="form-group">
				   <div class="col-sm-3"><label>Transport</label></div>
					<div class="col-sm-6"><input type="checkbox" name="transportCheckbox" value="red" >&nbsp;&nbsp;&nbsp;<strong> Select If Transport Not Required</strong>					</div>	
				</div>  		 		 
			</div>
		</div>
			...
			<div class="col-lg-6" id="userFormColumn8">
				...
				<div class="form-group">
				   <div class="col-sm-3"> <label for="vehicleDriver">Driver</label></div>
					...
					echo '<select id="new_select3" name="vehicleDriver"  class="form-control detail">
