...
<body>
	...
	<div id="printablediv" style="width: 100%; margin-left:50px; align:center;">
	
	<div id="rcorners2">
	
	<h3 style="margin-left:300px;align:center">Student Fees</h3> <br>	
				
				
	<div class="row clearfix">
			
	<div class="span_4 column">
       <label for="sel1">Receipt Number :</label>
				<?php echo $receiptNo  ;?> <p>
    </div>
    <div class="span_4 column">
    ...
    <div class="span_4 column">
        <label for="sel1">Guardian Name :</label> 
				<?php echo $guardianName ;?> <p> 
    </div>
	...
	<div class="span_4 column">
       <label for="sel1">Particular  :</label>
				<?php echo $particular; ?> <p>
    </div>
    <div class="span_4 column">
       <label for="sel1">Fees Amount :</label> 
				<?php echo "Rs. ". $feesAmount   ;?> <p>
    </div>
