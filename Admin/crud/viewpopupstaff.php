<?php
		...
		$result = $crud->getData("SELECT * FROM  staff_add WHERE staffSrno = '$id'");	
...
<body>
	 ...
	 <div class="row">
		...
		<input type="submit" value="Return" name="Submit" class="btn btn-primary" onclick="location.href = 'http://localhost/School%20ERP/Admin/viewstaff.php'">
	...
	<div id="rcorners2">
				...
				<h3 style="margin-left:250px;align:center">Staff Profile</h3> <br>	
				...
				<div class="span_4 column">
					<label for="sel1">Date of Joining :</label> 
							<?php echo $dateOfJoining ;?> <p>
				</div>
				...
				<div class="span_4 column">
					<label for="sel1">Post Applied :</label> 
							<?php echo $postApplied    ;?> <p>
				</div>
				<div class="span_4 column">
				...
				<div class="span_4 column">
					<label for="sel1">Staff Caste   :</label> 
							<?php echo $caste;?> <p> 
				</div>
				<div class="span_4 column">
				...
				<div class="span_4 column">
					<label for="sel1">Staff Address   :</label> 
							<?php echo $staffAddress;?> <p>  
				</div>
				<div class="span_4 column">
