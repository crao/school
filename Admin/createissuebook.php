...
function fetch_select1(val)
{
 $.ajax({
 type: 'post',
 url: 'fetch_data-libraryname.php',
 data: {
  get_option:val
 },
...
function fetch_select2(val1)
{
 $.ajax({
 type: 'post',
 url: 'fetch_data-libraryclass.php',
 data: {
  get_option:val1
 },
 success: function (response) {
...
function fetch_select3(val2)
{
 $.ajax({
 type: 'post',
 url: 'fetch_data-librarysection.php',
 data: {
  get_option:val2
 },
 success: function (response) {
  ...
  <div class="content-wrapper">
    <!-- Content Header (Page header) -->
	  ...
	  <div class="row" style="margin-left:5px;margin-right:5px;">
		...
		<div style="text-align: center"> <h3>Issue - Return Library Books </h3></div> <p> 
		 <p/>&nbsp;<p/>
          <form action="createissuebook.php" enctype="multipart/form-data" method="post">
		...
		<div class="container-fluid form-group"><!-- Row 4 -->
			...
			<div class="col-lg-6" id="userFormColumn7">
				...
				<div class="form-group">
					<div class="col-sm-3"><label for="class">Registration Number</label></div>
					<div class="col-sm-6">
					...
					$result = $crud->execute("TRUNCATE Table temp_staff_students");
					$result1 = $crud->execute("INSERT INTO temp_staff_students (staffId,chooseClass,section,fullName) SELECT staffId,chooseClass,section,fullName FROM staff_add WHERE staff='Teaching'");
					
					$result2 = $crud->execute("INSERT INTO temp_staff_students (staffId,chooseClass,section,fullName) SELECT studid,chooseClass,section,fullName FROM stu_admission");
					
					$result3 = $crud->getData("SELECT * FROM  temp_staff_students");
					
					echo "<select onChange='fetch_select1(this.value);fetch_select2(this.value);fetch_select3(this.value);' name='staffId'  class='form-control detail'>";
			...
			<div class="col-lg-6" id="userFormColumn8">
				...
				<div class="form-group">
				   <div class="col-sm-3"> <label for="Gender">Full Name</label></div>
					<div class="col-sm-6">
					
					<?php
					
					echo '<select id="new_select1" name="fullName"  class="form-control detail">
				.		 "<option>Select Full Name</option>".
					 </select>';
					?>						
		...
		<div class="container-fluid form-group"><!-- Row 4 -->
			...
			<div class="col-lg-6" id="userFormColumn7">
				...
				<div class="form-group">
					<div class="col-sm-3"><label for="class">Class</label></div>
					<div class="col-sm-6">
					
					<?php
					
					echo '<select id="new_select2" name="chooseClass"  class="form-control detail">
			...
			<div class="col-lg-6" id="userFormColumn8">
				...
				<div class="form-group">
				   <div class="col-sm-3"> <label for="Gender">Section</label></div>
					<div class="col-sm-6">
					
					<?php
					
					echo '<select id="new_select3" name="section"  class="form-control detail">
		...
		<div class="container-fluid form-group"><!-- Row 4 -->
			...
			<div class="col-lg-6" id="userFormColumn8">
				...
				<div class="form-group">
				   <div class="col-sm-3"> <label for="Gender">Category (Subject)</label></div>
					<div class="col-sm-6">
		...
		<div class="container-fluid form-group"><!-- Row Last -->
			...
			<div class="col-lg-12" id="studentSubmit">
				...
				<div class="form-group">
					...
					<div class="col-sm-4"><input type="submit"  value="Submit" name="SubmitIssue" class="btn btn-primary" />
					<p><br>
					<?php 
					error_reporting("0");
					echo $fullName1 = $_POST['fullName']; ?>
					</div>
		...
		echo '<form action="crud/issuebooks.php" enctype="multipart/form-data" method="post">';		
		
		include_once("classes/Crud.php");
		
		error_reporting("0");
		
		$staffStudentId1 = $_POST['staffId'];
		$fullName1 = $_POST['fullName'];
		$section1 = $_POST['section'];
		$class1 =  $_POST['chooseClass'];
		$category1	= $_POST['category'];
		$category	= $_POST['category'];
		
		if ( $crud->is_session_started() === FALSE ) session_start();
		
		$_SESSION['staffStudentId1'] = $staffStudentId1;
		$_SESSION['fullName1'] = $fullName1;
		...
		$query = "Select * from library_book WHERE category	 = '$category' ORDER BY srno Asc";
		
		$rows = $crud->getNorows($query); 
		
		
		$result = $crud->getData("SELECT * FROM library_book WHERE category	 = '$category' ORDER BY srno Asc Limit $start, $perpage");
		...
		<th style="border: 1px solid #FFFFFF;background: #3c8dbc;color: #FFFFFF;text-align: center; ">Book No</th>
		<th style="border: 1px solid #FFFFFF;background: #3c8dbc;color: #FFFFFF;text-align: center; ">Issued To</th>
		...
		<th style="border: 1px solid #FFFFFF;background: #3c8dbc;color: #FFFFFF;text-align: center; ">Issue Return</th>
			...
			?>
					...
					<input type="hidden" name="accessionNumber" value="<?php echo $accessionNumber; ?>">							
					
					<input type="hidden" name="staff_stu_Id1" value="<?php echo $staffStudentId1; ?>">
					<input type="hidden" name="fullName" value="<?php echo $fullName; ?>">							
					<input type="hidden" name="section" value="<?php echo $section; ?>">							

					<input type="hidden" name="fullName1" value="<?php echo $fullName1; ?>">							
			...
			<?php	  
				...
				echo '<td style="padding: 1px;border: 1PX solid #FFFFFF;background: #B0C4DE ;text-align:center;">' . $fullName . '</td>';
				echo '<td style="padding: 1px;border: 1PX solid #FFFFFF;background: #B0C4DE ;text-align:center;">' . $section . '</td>';
				...
				echo '<td style="padding: 1px;border: 1PX solid #FFFFFF;background: #B0C4DE ;">';?>
					...
					<input type="text" name="issue_date" class="form-control pull-right" id="" size="16" readonly value="<?php echo trim($issue_date); ?>" >
					</div>
				...
				echo '<td style="padding: 1px;border: 1PX solid #FFFFFF;background: #B0C4DE ;">'; ?>
					...
					<input type="text" name="due_date" class="form-control pull-right" id="" size="16" readonly value="<?php echo trim($due_date); ?>" >
					</div>
				...
				<input type="text" name="fine" readonly class='form-control detail' size="5" value="0">
				
				<?php '</td>';
				
				if(empty($fullName)) {
				
				echo '<td style="padding: 1px;border: 1PX solid #FFFFFF;background: #B0C4DE; text-align:center;"><a align href="createissuebook1.php?id=' . $accessionNumber . '">Issue</a></td>'; 
								
				}
				else {
				
				echo '<td style="padding: 1px;border: 1PX solid #FFFFFF;background: #B0C4DE; text-align:center;"><a align href="createissuebook2.php?id=' . $accessionNumber . '">Return</a></td>'; 	
		...
		$query = "Select count(*) As Total from library_book WHERE category = '$category' ";
		...
		$result = mysqli_query($conn, "Select count(*) As Total from library_book WHERE category = '$category'");
