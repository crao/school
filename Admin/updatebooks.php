...
<head>
  ...
  <title>Update Books Library</title>
  ...
  <div class="content-wrapper">
    <!-- Content Header (Page header) -->
	  ...
	  <div class="row" style="margin-left:5px;margin-right:5px;">
		...
		<div style="text-align: center"> <h3>Update Library Books </h3></div> <p> 
		 <p/>&nbsp;<p/>
		 ...
		 <?php
		  if (isset($_GET['id']) && is_numeric($_GET['id']) && $_GET['id'] > 0)
				...
				$result = $crud->getData("SELECT * FROM library_book WHERE 	srno = '$id' Limit 1");
				...
				foreach ($result as $res) {
						  ...
						  $coppies=$res['coppies']; 
						  $suplierName=$res['suplierName'];		
						  $descriptionNote=$res['descriptionNote'];		
				}		  
		?>	
		
          <form action="crud/updateaddbooks.php" enctype="multipart/form-data" method="post">
		...
		<div class="container-fluid form-group"><!-- Row 4 -->
			...
			<div class="col-lg-6" id="userFormColumn7">
				...
				<div class="form-group">
					...
					<input type="text" name="bookName" required class='form-control detail' value="<?php echo $bookName; ?>">
					</div>
			...
			<div class="col-lg-6" id="userFormColumn8">
				...
				<div class="form-group">
				   <div class="col-sm-3"> <label for="Gender">Book Author</label></div>
					...
					<input type="text" name="author" class='form-control detail' required value="<?php echo $author; ?>">
		...
		<div class="container-fluid form-group"><!-- Row 2 -->
			...
			<div class="col-lg-6" id="userFormColumn3">
				...
				<div class="form-group">
					...
					<input type="text" name="billNo" class='form-control detail' value="<?php echo $billNo; ?>">
			...
			<div class="col-lg-6" id="userFormColumn4">
				...
				<div class="form-group">
					...
					<input type="text" name="billDate" class="form-control pull-right" id="datepicker1" value="<?php echo $billDate; ?>">
					</div>
			...
			<div class="col-lg-6" id="userFormColumn7">
				...
				<div class="form-group">
					...
					<select name="bookType" required class='form-control detail'>
							<option><?php echo $bookType; ?></option>
							<option>Book</option>
			...
			<div class="col-lg-6" id="userFormColumn8">
				...
				<div class="form-group">
				   <div class="col-sm-3"> <label for="Gender">Book Edition</label></div>
					...
					<input type="text" name="bookEdition" class='form-control detail'  value="<?php echo $bookEdition; ?>">
		...
		<div class="container-fluid form-group"><!-- Row 4 -->
			...
			<div class="col-lg-6" id="userFormColumn7">
				...
				<div class="form-group">
					...
					<input type="text" name="yearofPublication"  class='form-control detail' value="<?php echo $yearofPublication; ?>">
					</div>
			...
			<div class="col-lg-6" id="userFormColumn8">
				...
				<div class="form-group">
				   <div class="col-sm-3"> <label for="Gender">Book Pages</label></div>
					...
					<input type="text" name="bookPages" class='form-control detail'  value="<?php echo $bookPages; ?>">
		...
		<div class="container-fluid form-group"><!-- Row 4 -->
			...
			<div class="col-lg-6" id="userFormColumn7">
				...
				<div class="form-group">
					...
					<input type="text" name="bookCost"  class='form-control detail' value="<?php echo $bookCost; ?>">
					</div>
			...
			<div class="col-lg-6" id="userFormColumn8">
				...
				<div class="form-group">
				   <div class="col-sm-3"> <label for="Gender">Publication Name</label></div>
					...
					<input type="text" name="bookPublication" class='form-control detail'  value="<?php echo $bookPublication; ?>">
		...
		<div class="container-fluid form-group"><!-- Row 4 -->
			...
			<div class="col-lg-6" id="userFormColumn7">
				...
				<div class="form-group">
					...
					<input type="text" name="libraryShelf" required class='form-control detail' value="<?php echo $libraryShelf; ?>">
			...
			<div class="col-lg-6" id="userFormColumn8">
				...
				<div class="form-group">
				   <div class="col-sm-3"> <label for="Gender">Number of Coppies</label></div>
					...
					<input type="text" name="coppies" required class='form-control detail'  value="<?php echo $coppies; ?>">
		...
		<div class="container-fluid form-group"><!-- Row 4 -->
			...
			<div class="col-lg-6" id="userFormColumn7">
				...
				<div class="form-group">
					...
					<input type="text" name="suplierName"  class='form-control detail' value="<?php echo $suplierName; ?>">
			...
			<div class="col-lg-6" id="userFormColumn8">
				...
				<div class="form-group">
				   <div class="col-sm-3"> <label for="Gender">Description Notes</label></div>
					...
					<textarea type="text" name="descriptionNote" class='form-control detail'><?php echo $descriptionNote; ?></textarea>
		...
		<div class="container-fluid form-group"><!-- Row Last -->
			...
			<div class="col-lg-12" id="studentSubmit">
				...
				<div class="form-group">
					...
					<div class="col-sm-4"><input type="submit"  value="Submit" name="SubmitUpdateBooks" class="btn btn-primary" /></div>
