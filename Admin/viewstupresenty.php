  ...
  <div class="content-wrapper">
    <!-- Content Header (Page header) -->
	  ...
	  <div class="row" style="margin-left:1px;margin-right:1px;">
		...
		<div style="text-align: center"> <h3>Student Presenty Report</h3></div> <p> 
		 <p/>&nbsp;<p/>
          <form action="viewstupresenty.php" method="post">
		...
		<div class="container-fluid form-group"><!-- Row 4 -->
			...
			<div class="col-lg-6" id="userFormColumn7">
				...
				<div class="form-group">
					...
					echo "<select onChange='fetch_select1(this.value);fetch_select2(this.value);' name='section'  class='form-control detail'>";
	...
	//	$endDate = date("d-m-Y", strtotime($endDate) );
		...
		$query = "Select * from stu_attendance WHERE  fullName = '$studentName' AND attDate BETWEEN  '$startDate' AND '$endDate'  ORDER BY attDate Asc";
		
		$rows = $crud->getNorows($query); 
		
		
		$result = $crud->getData("SELECT * FROM stu_attendance WHERE  fullName = '$studentName' AND attDate BETWEEN  '$startDate' AND '$endDate'  ORDER BY attDate Asc ");
