...
<head>
  ...
  <title>Staff Update Process</title>
  ...
  <div class="content-wrapper">
    <!-- Content Header (Page header) -->
	  ...
	  <div class="row">
		...
		<div style="text-align: center"> <h3>Update Staff Entry</h3></div> <p> 
		 <p/>&nbsp;<p/>
		 ...
		 <?php
			  ...
			  if (isset($_GET['id']) && is_numeric($_GET['id']) && $_GET['id'] > 0)
				...
				$result = $crud->getData("SELECT * FROM staff_add WHERE staffSrno = '$id' Limit 1");
				...
				foreach ($result as $res) {
						  ...
						  $prevPackage=$res['prevPackage']; 
						  $currentPackage=$res['currentPackage'];						  
	  ...
	  ?>
          ...
          <form action="crud/updateaddstaff.php" enctype="multipart/form-data" method="post">
			...
			<div class="col-lg-6" id="userFormColumn2">
				...
				<div class="form-group">
				   <div class="col-sm-3"><label for="adm_date">Date</label></div>
					...
					<input type="text" name="dateOfJoining" class="form-control pull-right" id="datepicker" value="<?php echo $dateOfJoining;?>">
					</div>
		...
		<div class="container-fluid form-group"><!-- Row 6 -->
			...
			<div class="col-lg-6" id="userFormColumn7">
				...
				<div class="form-group">
					<div class="col-sm-3"><label for="staff">Staff Details</label></div>
					<div class="col-sm-6"><input name='staff' class='form-control detail' type='text' placeholder='Enter Staff Details' value="<?php echo $staff; ?>">  <p>
				</div>
			...
			<div class="col-lg-6" id="userFormColumn8">
				...
				<div class="form-group">
				   <div class="col-sm-3"> <label for="Deaprtment">Deaprtment</label></div>
					<div class="col-sm-6"><input name='department' class='form-control detail' type='text' placeholder='Enter Deaprtment' value="<?php echo $department;?>">
		...
		<div class="container-fluid form-group"><!-- Row 8 -->
			...
			<div class="col-lg-6" id="userFormColumn7">
				...
				<div class="form-group">
					<div class="col-sm-3"><label for="postApplied">Post Applied</label></div>
					<div class="col-sm-6"><input name='postApplied' class='form-control detail' type='text' placeholder='Enter Post Applied' value="<?php echo $postApplied;?>">  <p>
				</div>
		...
		<div class="container-fluid form-group"><!-- Row 12 -->
			...
			<div class="col-lg-6" id="userFormColumn7">
				...
				<div class="form-group">
					<div class="col-sm-3"><label for="prevPackage">Previous Package</label></div>
					<div class="col-sm-6">
					<input type="text" class="form-control" id="prevPackage" required name="prevPackage" placeholder="Enter Previous Package" value="<?php echo $prevPackage;?>">	
			...
			<div class="col-lg-6" id="userFormColumn8">
				...
				<div class="form-group">
				   <div class="col-sm-3"> <label for="currentPackage">Current Package</label></div>
					<div class="col-sm-6"><input type="text" class="form-control" id="currentPackage" required name="currentPackage" placeholder="Enter Current Package" value="<?php echo $currentPackage;?>">	
		...
		<div class="container-fluid form-group"><!-- Row 15 -->
			...
			<div class="col-lg-6" id="userFormColumn7">
				...
				<div class="form-group">
					...
					<div class="col-sm-6"><input type="text" class="form-control" id="staffAddress" required  name="staffAddress" placeholder="Enter Address" value="<?php echo $staffAddress ;?>">  <p>
				</div>
		...
		<div class="container-fluid form-group"><!-- Row 19 -->
			...
			<div class="col-lg-6" id="userFormColumn7">
				...
				<div class="form-group">
					<div class="col-sm-3"><label for="Remarks">Remarks</label></div>
					<div class="col-sm-6"><textarea type="text" class="form-control" id="remarks" name="remarks" placeholder="Enter Remarks" value="<?php echo $remarks;?>"><?php echo $remarks;?> </textarea> <p>
				</div>
