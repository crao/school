...
<head>
  ...
  <title>School ERP -View Students</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper" align="center">
    <!-- Content Header (Page header) -->
	  ...
	  <h3 style="margin-left:20px;text-align:center;">View Student Admission List</h3> 
	  
        
	<p></br>	
	<div class="container" align="center">
	<form class="form-inline" role="form"  action="viewstudent.php" method="post">
    ...
    <div class="form-group">
	  ...
	  <input type="submit" value="Reset" name="Reset" class="btn btn-primary"> 
		...
		$query = "Select * from stu_admission";
		
		$rows = $crud->getNorows($query);
		
		
		$result = $crud->getData("SELECT * FROM stu_admission Order by stusrno Desc Limit $start, $perpage");
		...
		$query = "Select * from stu_admission WHERE firstName='$first_name' ";
		
		$rows = $crud->getNorows($query);
		
		
		$result = $crud->getData("SELECT * FROM stu_admission WHERE firstName='$first_name' Order by stusrno Desc Limit $start, $perpage");
		...
		$query = "Select * from stu_admission WHERE last_name='$last_name'";
		
		$rows = $crud->getNorows($query);
		
		
		$result = $crud->getData("SELECT * FROM stu_admission WHERE lastName='$last_name' Order by stusrno Desc Limit $start, $perpage");
		...
		<th style="border: 1px solid #FFFFFF;background: #3c8dbc;color: #FFFFFF;text-align: center; ">Student ID</th> 
		...
		<th style="border: 1px solid #FFFFFF;background: #3C8DBC;color: #FFFFFF;text-align: center; ">Delete User</th>
			...
			foreach ($result as $res) {
                ...
                echo '<td style="padding: 1px;border: 1PX solid #FFFFFF;background: #B0C4DE ;">' . $studid . '</td>';
				...
				echo '<td style="padding: 1px;border: 1PX solid #FFFFFF;background: #B0C4DE ;">' . $stuAddress . '</td>';			
				echo '<td style="padding: 1px;border: 1PX solid #FFFFFF;background: #B0C4DE ;">' . $city . '</td>';	
				
				echo '<td style="padding: 1px;border: 1PX solid #FFFFFF;background: #B0C4DE; text-align:center;"><a align href="crud/viewpopupstudent.php?id=' . $id . '" id="btnShow">View</a></td>';
				
				echo '<td style="padding: 1px;border: 1PX solid #FFFFFF;background: #B0C4DE; text-align:center;"><a align href="updatestudent.php?id=' . $id . '">Update</a></td>'; 
				
				echo '<td style="padding: 1px;border: 1PX solid #FFFFFF;background: #B0C4DE; text-align:center;"><a align href="crud/deletestudent.php?id=' . $id . '" onclick="return confirmDelete()">Delete</a></td>';	
                echo "</tr>"; 
...
<p><br>
	<table width="400" cellspacing="2" cellpadding="2" align="center">
		...
		$query = "Select count(*) As Total from stu_admission";
		...
		$result = mysqli_query($conn, "Select count(*) As Total from stu_admission");
		...
		echo "<span><a id='page_a_link' href='viewstudent.php?page=$j'>&nbsp;&nbsp;< Prev&nbsp;&nbsp;</a></span>";
		...
		echo "<span><a id='page_a_link' href='viewstudent.php?page=$i'>&nbsp;&nbsp;$i&nbsp;&nbsp;</a></span>";
		...
		echo "<span><a id='page_a_link' href='viewstudent.php?page=$j'>&nbsp;&nbsp;Next >&nbsp;&nbsp;</a></span>";
