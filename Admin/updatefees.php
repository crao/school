...
<head>
  ...
  <title>Student Fees Update</title>
  ...
  <div class="content-wrapper">
    <!-- Content Header (Page header) -->
	  ...
	  <div class="row">
		...
		<div style="text-align: center"> <h3>Student Fees Update</h3></div> <p> 
		 <p/>&nbsp;<p/>
		 ...
		 <?php
			  ...
			  if (isset($_GET['id']) && is_numeric($_GET['id']) && $_GET['id'] > 0)
				...
				$result = $crud->getData("SELECT * FROM stu_fees_collection WHERE fee_receipt = '$id' Limit 1");
	  ...
	  ?>
          ...
          <form action="crud/updateaddfees.php" enctype="multipart/form-data" method="post">
			...
			<div class="col-lg-6" id="userFormColumn1" >		 
				...
				<div class="form-group">
				   <div class="col-sm-3"> <label for="studentId">Receipt Number</label></div>
				   <div class="col-sm-6">
				   <input type="text" name="receiptNo" class="form-control" value="<?php echo $receiptNo; ?>" >
			...
			<div class="col-lg-6" id="userFormColumn2">
				...
				<div class="form-group">
				   <div class="col-sm-3"><label for="adm_date">Receipt Date</label></div>
					<div class="col-sm-6">
					...
					<input type="text" name="feesDate" class="form-control pull-right" id="datepicker" value="<?php echo $feesDate;?>">
					</div>
		...
		<div class="container-fluid form-group"><!-- Row 2 -->
			...
			<div class="col-lg-6" id="userFormColumn3">
				...
				<div class="form-group">
					<div class="col-sm-3"><label for="pre_title">Academic Year</label></div>
					<div class="col-sm-6">
			...
			<div class="col-lg-6" id="userFormColumn4">
				...
				<div class="form-group">
				   <div class="col-sm-3"> <label for="firstName">Payment Mode</label></div>
					<div class="col-sm-6">
		...
		<div class="container-fluid form-group"><!-- Row 3 -->
			...
			<div class="col-lg-6" id="userFormColumn5">
				...
				<div class="form-group">
					<div class="col-sm-3"><label for="middleName">Father/Guardian Name</label></div>
					<div class="col-sm-6"><input name="guardianName" id="guardianName" value="<?php echo $guardianName; ?>" class="form-control" placeholder="Enter Guardian Name"></div>
			...
			<div class="col-lg-6" id="userFormColumn6">
				...
				<div class="form-group">
				   <div class="col-sm-3"> <label for="lastName">Select Class</label></div>
					<div class="col-sm-6">
		...
		<div class="container-fluid form-group"><!-- Row 4 -->
			...
			<div class="col-lg-6" id="userFormColumn7">
				...
				<div class="form-group">
					<div class="col-sm-3"><label for="academicYear">Select Division</label></div>
					<div class="col-sm-6">
					<?php	
			...
			<div class="col-lg-6" id="userFormColumn8">
				...
				<div class="form-group">
				   <div class="col-sm-3"> <label for="Gender">Select Student</label></div>
					<div class="col-sm-6">
		...
		<div class="container-fluid form-group"><!-- Row 5 -->
			...
			<div class="col-lg-6" id="userFormColumn7">
				...
				<div class="form-group">
					<div class="col-sm-3"><label for="uploadPhoto">Mobile Number</label></div>
					<div class="col-sm-6">
					
					<?php
					
					echo '<select id="new_select2" name="mobileNumber"  class="form-control detail">'; ?>
					<option><?php echo $mobileNumber; ?></option>
					<?php
					 echo '</select>';
					?>	
			...
			<div class="col-lg-6" id="userFormColumn8">
				...
				<div class="form-group">
				   <div class="col-sm-3"> <label for="dateOfBirth">Email Id</label></div>
					<div class="col-sm-6">
					...
					<option><?php echo $emailID; ?></option>
		...
		<div class="container-fluid form-group"><!-- Row 6 -->
			...
			<div class="col-lg-6" id="userFormColumn7">
				...
				<div class="form-group">
					...
					<div class="col-sm-6"><input name='remark' class='form-control detail' type='text' placeholder='Enter Remark' value="<?php echo $remark;?>">  <p>
				</div>
			...
			<div class="col-lg-6" id="userFormColumn8">
				...
				<div class="form-group">
				   <div class="col-sm-3"> <label for="medicalHistory">Alert/Notifications</label></div>
					<div class="col-sm-6">
		...
		<div class="container-fluid form-group"><!-- Row 10 -->
			...
			<div class="col-lg-6" id="userFormColumn7">
				...
				<div class="form-group">
					<div class="col-sm-3"><label for="userName">Particular</label></div>
					<div class="col-sm-6">
					...
					$result = $crud->getData("SELECT  particular FROM  stu_fees");
						...
						<option><?php echo $particular; ?></option>
			...
			<div class="col-lg-6" id="userFormColumn8">
				...
				<div class="form-group">
				   <div class="col-sm-3"> <label for="userPassword">Amount</label></div>
					<div class="col-sm-6"><input name="feesAmount" id="feesAmount" value="<?php echo $feesAmount; ?>" class="form-control" placeholder="Fees Amount">
