    ...
    <!-- Content Header (Page header) -->
	  ...
	  <div class="row" style="margin-left:5px;margin-right:5px;">
		...
		<div style="text-align: center"> <h3>School Holidays</h3></div> <p> 
		 <p/>&nbsp;<p/>
          <form action="crud/addholidays.php" enctype="multipart/form-data" method="post">
		...
		<div class="container-fluid form-group"><!-- Row 4 -->
			...
			<div class="col-lg-6" id="userFormColumn7">
				...
				<div class="form-group">
					...
					<input type="text" name="occasion" required class='form-control detail' placeholder="Enter Holidays Occasion">
					</div>
			...
			<div class="col-lg-6" id="userFormColumn8">
				...
				<div class="form-group">
				   <div class="col-sm-3"> <label for="Gender">Holidays Details</label></div>
					...
					<input type="text" name="details" class='form-control detail' placeholder="Enter Holidays Details">
		...
		<div class="container-fluid form-group"><!-- Row Last -->
			...
			<div class="col-lg-12" id="studentSubmit">
				...
				<div class="form-group">
					...
					<div class="col-sm-4"><input type="submit"  value="Submit" name="SubmitHolidays" class="btn btn-primary" /></div>
