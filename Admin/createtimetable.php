  ...
  <div class="content-wrapper">
    <!-- Content Header (Page header) -->
	  ...
	  <div class="row" style="margin-left:5px;margin-right:5px;">
		...
		<div style="text-align: center"> <h3>School Timetable</h3></div> <p> 
		 <p/>&nbsp;<p/>
          <form action="crud/addtimetablestaff.php" enctype="multipart/form-data" method="post">
		...
		$query = "Select * from timetable_days ORDER BY srno Asc";
...
echo '<tr> <th style="border: 1px solid #FFFFFF;background: #3c8dbc;color: #FFFFFF; text-align: center; ">Days</th> 
		...
		<option>05:15 TO 06:00</option>
			...
			foreach ($result as $res) {
				...
				echo '<td style="padding: 1px;border: 1PX solid #FFFFFF;background: #B0C4DE ; text-align:center;">' . $break . '</td>';
		...
		<div class="container-fluid form-group"><!-- Row Last -->
			...
			<div class="col-lg-12" id="studentSubmit">
				...
				<div class="form-group">
					...
					<div class="col-sm-4">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit"  value="Submit" name="SubmitTimetable" class="btn btn-primary" /></div>
