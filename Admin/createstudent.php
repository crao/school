    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
		...
		<li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="#"><i class="fa fa-circle-o"></i>Add Staff</a></li>
    ...
    <!-- Content Header (Page header) -->
	  ...
	  <div class="row">
		...
		<div style="text-align: center"> <h3>Student Admission</h3></div> <p> 
		 <p/>&nbsp;<p/>
          <form action="crud/addstudent.php" enctype="multipart/form-data" method="post">
			...
			<div class="col-lg-6" id="userFormColumn2">
				...
				<div class="form-group">
				   <div class="col-sm-3"><label for="adm_date">Date</label></div>
					...
					<input type="text" name="admissiondate" class="form-control pull-right" id="datepicker">
					</div>
		...
		<div class="container-fluid form-group"><!-- Row 3 -->
			...
			<div class="col-lg-6" id="userFormColumn5">
				...
				<div class="form-group">
					...
					<div class="col-sm-6"><input name="middleName" id="middleName" required class="form-control" placeholder="Enter Middle Name"></div>
		...
		<div class="container-fluid form-group"><!-- Row 6 -->
			...
			<div class="col-lg-6" id="userFormColumn7">
				...
				<div class="form-group">
					...
					<div class="col-sm-6"><input name='bloodGroup' class='form-control detail' type='text' placeholder='Enter Blood Group'>  <p>
				</div>
			...
			<div class="col-lg-6" id="userFormColumn8">
				...
				<div class="form-group">
				   <div class="col-sm-3"> <label for="medicalHistory">Medical History</label></div>
					<div class="col-sm-6"><input name='medicalHistory' class='form-control detail' type='text' placeholder='Enter Medical History'>
		...
		<div class="container-fluid form-group"><!-- Row 8 -->
			...
			<div class="col-lg-6" id="userFormColumn7">
				...
				<div class="form-group">
					...
					<div class="col-sm-6"><input name='fatherName' class='form-control detail' type='text' placeholder='Enter Father Name'>  <p>
				</div>
			...
			<div class="col-lg-6" id="userFormColumn8">
				...
				<div class="form-group">
				   <div class="col-sm-3"> <label for="motherName">Mother's Name</label></div>
					<div class="col-sm-6"><input name='motherName' class='form-control detail' type='text' placeholder='Enter Mother Name'>
		...
		<div class="container-fluid form-group"><!-- Row 10 -->
			...
			<div class="col-lg-6" id="userFormColumn7">
				...
				<div class="form-group">
					...
					<div class="col-sm-6"><input type="text" class="form-control" readonly id="userName" name="userName" value="<?php echo $studid = $studid;  ?>" > <p> 
				</div>
			...
			<div class="col-lg-6" id="userFormColumn8">
				...
				<div class="form-group">
				   <div class="col-sm-3"> <label for="hobbies">Hobbies</label></div>
					<div class="col-sm-6"><textarea type="text" class="form-control" required id="hobbies" name="hobbies" placeholder="Enter Hobbies"></textarea>
		...
		<div class="container-fluid form-group"><!-- Row 13 -->
			...
			<div class="col-lg-6" id="userFormColumn7">
				...
				<div class="form-group">
					...
					<div class="col-sm-6"><input type="text" class="form-control" id="Religion" required name="religion" placeholder="Enter Religion">  <p>
				</div>
		...
		<div class="container-fluid form-group"><!-- Row 15 -->
			...
			<div class="col-lg-6" id="userFormColumn7">
				...
				<div class="form-group">
					...
					<div class="col-sm-6"><input type="text" class="form-control" id="stuAddress" required  name="stuAddress" placeholder="Enter Address">  <p>
				</div>
			...
			<div class="col-lg-6" id="userFormColumn8">
				...
				<div class="form-group">
				   <div class="col-sm-3"> <label for="country">Country</label></div>
					<div class="col-sm-6"><input name='country' class='form-control detail' type='text' placeholder='Enter Country'>
		...
		<div class="container-fluid form-group"><!-- Row 16 -->
			...
			<div class="col-lg-6" id="userFormColumn7">
				...
				<div class="form-group">
					...
					<div class="col-sm-6"><input type="text" class="form-control" id="state"  name="state" placeholder="Enter State">  <p>
				</div>
			...
			<div class="col-lg-6" id="userFormColumn8">
				...
				<div class="form-group">
				   <div class="col-sm-3"> <label for="city">City</label></div>
					<div class="col-sm-6"><input name='city' class='form-control detail' type='text' placeholder='Enter City'>
		...
		<div class="container-fluid form-group"><!-- Row 18 -->
			...
			<div class="col-lg-6" id="userFormColumn7">
				...
				<div class="form-group">
					...
					<div class="col-sm-6"><input type="text" class="form-control" id="prevSchool"  name="prevSchool" placeholder="Enter Previous School">  <p>
				</div>
			...
			<div class="col-lg-6" id="userFormColumn8">
				...
				<div class="form-group">
				   <div class="col-sm-3"> <label for="prevPercent">Previous Percentage</label></div>
					<div class="col-sm-6"><input name='prevPercent' id="prevPercent" class='form-control detail' type='text' placeholder='Enter Previous Percentage'><br>
		...
		<div class="container-fluid form-group"><!-- Row 19 -->
			...
			<div class="col-lg-6" id="userFormColumn7">
				...
				<div class="form-group">
					...
					<div class="col-sm-6"><input type="text" class="form-control" id="prevYearPass" name="prevYearPass" placeholder="Enter Previous Year of Passing">  <p>
				</div>
