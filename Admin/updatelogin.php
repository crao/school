  ...
  <div class="content-wrapper">
    <!-- Content Header (Page header) -->
	  ...
	  <div class="row centered-form">
	   ...
	   <div align="center"><h3>Update Login Authority</h3></div>
      <?php
	  if (isset($_GET['id']) && is_numeric($_GET['id']) && $_GET['id'] > 0)
		...
		$result = $crud->getData("SELECT * FROM login_authority WHERE id = '$id' Limit 1");
	  ...
	  ?>
          ...
          <form action="crud/updateaddlogin.php" enctype="multipart/form-data" method="post">
              
              
				<div align="left" class="form-group">
				
				<div class="col-sm-4"><label for="sel1">User Name</label> </div>
				<div class="col-sm-8"><input type="text" class="form-control" required id="exampleInputEmail1" name="username" placeholder="Enter email address" value="<?php echo $username;?>"> <p>
				</div> </div>
					
                
				<div align="left" class="form-group">
                  <div class="col-sm-4"><label for="sel1">Password</label></div>
                  <div class="col-sm-8"><input type="text" class="form-control" required id="exampleInputPassword1" name="password" placeholder="Password" value="<?php echo $password;?>"> <p>
                </div> </div>
					
				
				<div align="left" class="form-group">
                  <div class="col-sm-4"><label for="sel1">First Name</label></div>
                  <div class="col-sm-8"><input type="text" class="form-control" id="exampleInputEmail1" name="first_name" placeholder="Enter First Name" value="<?php echo $first_name;?>"> <p>
                </div> </div>
					
				
				<div align="left" class="form-group">
                  <div class="col-sm-4"><label for="sel1">Last Name</label></div>
                  <div class="col-sm-8"><input type="text" class="form-control" id="exampleInputEmail1" name="last_name" placeholder="Enter Last Name" value="<?php echo $last_name;?>">  <p>
                </div> </div>
				...
				<div align="left" class="form-group">
                  ...
                  <div class="col-sm-8"><input type="email" class="form-control" id="exampleInputEmail1" required name="email" placeholder="Enter email ID" value="<?php echo $email;?>">  <p>
                </div> </div>
				
				
				<div align="left" class="form-group">
                  <div class="col-sm-4"><label for="sel1">Mobile Number</label></div>
                  <div class="col-sm-8"><input type="text" class="form-control" id="exampleInputEmail1" required name="mobile" placeholder="Enter Mobile" value="<?php echo $mobile;?>">  <p>
                </div> </div>
				...
				<div align="left" class="form-group">
				  ...
				  <option value="<?php echo $authority;?>"><?php echo $authority;?></option>
                ...
                <div align="left" class="form-group">
				  ...
				  <div class="col-sm-8"><input name='filename' class='form-control detail' type='file' style="width: 210px;">
				  <p>
			  ...
			  <div align="left" class="form-group">
               ...
               <div align="left" class="form-group">
				...
				<div class="col-sm-8"><input type="submit"  value="Submit" name="UpdateSubmit" class="btn btn-primary" /></div>
              </div>
