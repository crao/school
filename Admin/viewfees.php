...
<head>
  ...
  <title>School ERP - View Fees Paid</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper" align="center">
    <!-- Content Header (Page header) -->
	  ...
	  <h3 style="margin-left:20px;text-align:center;">View Fees Paid List</h3> 
	  
        
	<p></br>	
	<div class="container" align="center">
	<form class="form-inline" role="form"  action="viewfees.php" method="post">
    ...
    <div class="form-group">
	  ...
	  <input type="submit" value="Reset" name="Reset" class="btn btn-primary"> 
		...
		$query = "Select * from stu_fees_collection";
		
		$rows = $crud->getNorows($query);
		
		
		$result = $crud->getData("SELECT * FROM stu_fees_collection  Order by 	fee_receipt Desc Limit $start, $perpage");
		...
		$query = "Select * from stu_fees_collection WHERE studentName like '$first_name%' ";
		
		$rows = $crud->getNorows($query);
		
		
		$result = $crud->getData("SELECT * FROM stu_fees_collection WHERE studentName like '$first_name%' Order by fee_receipt Desc Limit $start, $perpage");
		...
		$query = "Select * from stu_fees_collection WHERE studentName like '%$last_name'";
		
		$rows = $crud->getNorows($query);
		
		
		$result = $crud->getData("SELECT * FROM stu_fees_collection WHERE studentName like '%$last_name' Order by fee_receipt Desc Limit $start, $perpage");
		...
		<th style="border: 1px solid #FFFFFF;background: #3c8dbc;color: #FFFFFF;text-align: center; ">&nbsp;&nbsp;&nbsp;Receipt No&nbsp;&nbsp;&nbsp;</th> 
		<th style="border: 1px solid #FFFFFF;background: #3c8dbc;color: #FFFFFF;text-align: center; ">&nbsp;Fees Date</th> 
		<th style="border: 1px solid #FFFFFF;background: #3c8dbc;color: #FFFFFF;text-align: center; ">&nbsp;Payment Mode</th> 
		<th style="border: 1px solid #FFFFFF;background: #3c8dbc;color: #FFFFFF;text-align: center; ">&nbsp;Division</th> 
		<th style="border: 1px solid #FFFFFF;background: #3c8dbc;color: #FFFFFF;text-align: center; ">&nbsp;Student Name</th>
		<th style="border: 1px solid #FFFFFF;background: #3c8dbc;color: #FFFFFF;text-align: center; ">&nbsp;Guardian Name</th>
		<th style="border: 1px solid #FFFFFF;background: #3c8dbc;color: #FFFFFF;text-align: center; ">&nbsp;Mobile Number</th>		
		<th style="border: 1px solid #FFFFFF;background: #3c8dbc;color: #FFFFFF;text-align: center; ">&nbsp;Particular</th>
		<th style="border: 1px solid #FFFFFF;background: #3c8dbc;color: #FFFFFF;text-align: center; ">&nbsp;Fees Amount</th>
		...
		<th style="border: 1px solid #FFFFFF;background: #3C8DBC;color: #FFFFFF;text-align: center; ">&nbsp;Delete User</th>
			...
			foreach ($result as $res) {
                ...
                echo '<td style="padding: 1px;border: 1PX solid #FFFFFF;background: #B0C4DE ;">' . $receiptNo . '</td>';
                echo '<td style="padding: 1px;border: 1PX solid #FFFFFF;background: #B0C4DE ;">' . $feesDate . '</td>';
				echo '<td style="padding: 1px;border: 1PX solid #FFFFFF;background: #B0C4DE ;">' . $paymentMode . '</td>';
				echo '<td style="padding: 1px;border: 1PX solid #FFFFFF;background: #B0C4DE ;">' . $division . '</td>';
				echo '<td style="padding: 1px;border: 1PX solid #FFFFFF;background: #B0C4DE ;">' . $studentName . '</td>';
				echo '<td style="padding: 1px;border: 1PX solid #FFFFFF;background: #B0C4DE ;">' . $guardianName . '</td>';
				echo '<td style="padding: 1px;border: 1PX solid #FFFFFF;background: #B0C4DE ;">' . $mobileNumber . '</td>';
				echo '<td style="padding: 1px;border: 1PX solid #FFFFFF;background: #B0C4DE ;">' . $particular . '</td>';			
				echo '<td style="padding: 1px;border: 1PX solid #FFFFFF;background: #B0C4DE ;">' . $feesAmount . '</td>';	
				
				echo '<td style="padding: 1px;border: 1PX solid #FFFFFF;background: #B0C4DE; text-align:center;"><a align href="crud/viewpopupfees.php?id=' . $id . '" id="btnShow">View</a></td>';
				
				echo '<td style="padding: 1px;border: 1PX solid #FFFFFF;background: #B0C4DE; text-align:center;"><a align href="updatefees.php?id=' . $id . '">Update</a></td>'; 
				
				echo '<td style="padding: 1px;border: 1PX solid #FFFFFF;background: #B0C4DE; text-align:center;"><a align href="crud/deletefees.php?id=' . $id . '" onclick="return confirmDelete()">Delete</a></td>';	
                echo "</tr>"; 
  ...
  <!-- /.content-wrapper -->
	...
	<table width="400" cellspacing="2" cellpadding="2" align="center">
		...
		$query = "Select count(*) As Total from stu_fees_collection";
		...
		$result = mysqli_query($conn, "Select count(*) As Total from stu_fees_collection");
		...
		echo "<span><a id='page_a_link' href='viewfees.php?page=$j'>&nbsp;&nbsp;< Prev&nbsp;&nbsp;</a></span>";
		...
		echo "<span><a id='page_a_link' href='viewfees.php?page=$i'>&nbsp;&nbsp;$i&nbsp;&nbsp;</a></span>";
		...
		echo "<span><a id='page_a_link' href='viewfees.php?page=$j'>&nbsp;&nbsp;Next >&nbsp;&nbsp;</a></span>";
