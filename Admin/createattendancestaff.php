  ...
  <div class="content-wrapper">
    <!-- Content Header (Page header) -->
	  ...
	  <div class="row" style="margin-left:5px;margin-right:5px;">
		...
		<div style="text-align: center"> <h3>Staff Daily Attendance</h3></div> <p> 
		 <p/>&nbsp;<p/>
          <form action="createattendancestaff.php" enctype="multipart/form-data" method="post">
		...
		<div class="container-fluid form-group"><!-- Row 2 -->
			...
			<div class="col-lg-6" id="userFormColumn3">
				...
				<div class="form-group">
					...
					<input type="text" name="attDate" class="form-control pull-right" id="datepicker">
					</div>
		...
		<div class="container-fluid form-group"><!-- Row Last -->
			...
			<div class="col-lg-12" id="studentSubmit">
				...
				<div class="form-group">
					...
					<div class="col-sm-4"><input type="submit"  value="Submit" name="SubmitPresentyStaff" class="btn btn-primary" /></div>
	...
	?>
		...
		<form action="crud/addattendancestaff.php" enctype="multipart/form-data" method="post">
		...
		echo "<h4>"."Presenty for ". $attDate."</h4>";
		...
		$query = "Select * from  staff_add WHERE  department = '$department'  ";
		
		$rows = $crud->getNorows($query); 
		
		
		$result = $crud->getData("SELECT * FROM  staff_add WHERE  department = '$department' ");
		...
		<th style="border: 1px solid #FFFFFF;background: #3c8dbc;color: #FFFFFF;text-align: center; ">Presenty</th>
		<th style="border: 1px solid #FFFFFF;background: #3c8dbc;color: #FFFFFF;text-align: center; ">Remark</th>
			...
			foreach ($result as $res) {
				...
				<input type="text" name="staffId[]" readonly value="<?php echo $staffId; ?>">
				...
				<input type="text" name="firstName[]" readonly value="<?php echo $firstName; ?>">

				<?php '</td>';
				
				echo '<td style="padding: 1px;border: 1PX solid #FFFFFF;background: #B0C4DE;">'; ?>
			
				<input type="text" name="lastName[]" readonly value="<?php echo $lastName; ?>">
				
				<?php echo '</td>';
				
				echo '<td style="padding: 1px;border: 1PX solid #FFFFFF;background: #B0C4DE;">' ; ?>
				
				<input type="text" name="department[]" readonly value="<?php echo $department; ?>">
				
				<?php '</td>'; 
				
				echo '<td style="padding: 1px;border: 1PX solid #FFFFFF;background: #B0C4DE;">' ?>
				
				<input type="text" name="section[]" readonly value="<?php echo $section; ?>">
				
				<?php echo '</td>';
				
				echo '<td style="padding: 1px;border: 1PX solid #FFFFFF;background: #B0C4DE;">' ?>
				
				<select name="attendance[]" class='form-control detail' >
				...
				<input type="text" name="remark[]"  value="" placeholder="Enter Remark">
				
				<input type="hidden" name="attDate[]"  value="<?php echo $attDate; ?>">
				<input type="hidden" name="academicYear[]"  value="<?php echo $academicYear; ?>">
