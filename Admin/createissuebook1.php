  ...
  <div class="content-wrapper">
    <!-- Content Header (Page header) -->
	  ...
	  <div class="row" style="margin-left:5px;margin-right:5px;">
		...
		<div style="text-align: center"> <h3>Issue Library Books </h3></div> <p> 
		 <p/>&nbsp;<p/>
          
		  <form action="crud/issuebooks.php" enctype="multipart/form-data" method="post">
		...
		<div class="container-fluid form-group"><!-- Row 4 -->
			...
			<div class="col-lg-6" id="userFormColumn7">
				...
				<div class="form-group">
					...
					$staffStudentId1 = $_SESSION['staffStudentId1'];
					$fullName1 = $_SESSION['fullName1'];
					...
					<input type="text" name="staffId" readonly value="<?php echo "  ". $staffStudentId1; ?>" >	
			...
			<div class="col-lg-6" id="userFormColumn8">
				...
				<div class="form-group">
				   <div class="col-sm-3"> <label for="Gender">Full Name</label></div>
					<div class="col-sm-6">
					<input type="text" name="fullName" readonly value="<?php echo "  ". $fullName1; ?>" >	
		...
		<div class="container-fluid form-group"><!-- Row 4 -->
			...
			<div class="col-lg-6" id="userFormColumn7">
				...
				<div class="form-group">
					...
					<input type="text" name="chooseClass" readonly value="<?php echo "  ". $class1; ?>" >	
			...
			<div class="col-lg-6" id="userFormColumn8">
				...
				<div class="form-group">
				   <div class="col-sm-3"> <label for="Gender">Section</label></div>
					...
					<input type="text" name="section" readonly value="<?php echo "  ". $section1; ?>" >	
			...
			<div class="col-lg-6" id="userFormColumn8">
				...
				<div class="form-group">
				   <div class="col-sm-3"> <label for="Gender">Category (Subject)</label></div>
					...
					<input type="text" name="category" readonly value="<?php echo "  ". $category1; ?>" >	
		...
		$query = "Select * from library_book WHERE accessionNumber	 = '$accessionNumber' ORDER BY srno Asc";
		
		$rows = $crud->getNorows($query); 
		
		
		$result = $crud->getData("SELECT * FROM library_book WHERE accessionNumber	 = '$accessionNumber' ORDER BY srno Asc Limit $start, $perpage");
		...
		<th style="border: 1px solid #FFFFFF;background: #3c8dbc;color: #FFFFFF;text-align: center; ">Issue Return</th>
			...
			?>
					...
					<input type="hidden" name="staff_stu_Id" value="<?php echo $staffStudentId1; ?>">
					<input type="hidden" name="fullName" value="<?php echo $fullName1; ?>">							
			...
			<?php	  
				...
				echo '<td style="padding: 1px;border: 1PX solid #FFFFFF;background: #B0C4DE ;">';?>
					...
					<input type="text" name="issue_date" class="form-control pull-right" id="datepicker" size="16" value="<?php echo trim($issue_date); ?>" >
					</div>
				...
				echo '<td style="padding: 1px;border: 1PX solid #FFFFFF;background: #B0C4DE ;">'; ?>
					...
					<input type="text" name="due_date" class="form-control pull-right" id="datepicker1" size="16" value="<?php echo trim($due_date); ?>" >
					</div>
				...
				<input type="text" name="fine" class='form-control detail' size="5" value="0">
				
				<?php '</td>';
				
				if(empty($fullName)) {
				
				echo '<td style="padding: 1px;border: 1PX solid #FFFFFF;background: #B0C4DE; text-align:center;"><input type="submit"  value="Issue" name="SubmitIssueBook" class="btn btn-primary" /></td>'; 
