  ...
  <div class="content-wrapper">
    <!-- Content Header (Page header) -->
	  ...
	  <div class="row" style="margin-left:5px;margin-right:5px;">
		...
		<div style="text-align: center"> <h3>Students Daily Attendance</h3></div> <p> 
		 <p/>&nbsp;<p/>
          <form action="createattendance.php" enctype="multipart/form-data" method="post">
		...
		<div class="container-fluid form-group"><!-- Row Last -->
			...
			<div class="col-lg-12" id="studentSubmit">
				...
				<div class="form-group">
					...
					<div class="col-sm-4"><input type="submit"  value="Submit" name="SubmitAttendance" class="btn btn-primary" /></div>
	...
	?>
		...
		<form action="crud/addattendance.php" enctype="multipart/form-data" method="post">
		...
		$query = "Select * from stu_admission WHERE section = '$section'";
		
		$rows = $crud->getNorows($query); 
		
		
		$result = $crud->getData("SELECT * FROM stu_admission  WHERE section = '$section' Order by stusrno Asc");
		...
		<th style="border: 1px solid #FFFFFF;background: #3c8dbc;color: #FFFFFF;text-align: center; ">Remark</th>
			...
			foreach ($result as $res) {
				...
				<input type="text" name="chooseClass[]" readonly value="<?php echo $chooseClass; ?>">
