  ...
  <div class="content-wrapper">
    <!-- Content Header (Page header) -->
	  ...
	  <div class="row" style="margin-left:5px;margin-right:5px;">
		...
		<div style="text-align: center"> <h3>School Holidays</h3></div> <p> 
		 <p/>&nbsp;<p/>
		 <?php
		  if (isset($_GET['id']) && is_numeric($_GET['id']) && $_GET['id'] > 0)
				...
				$result = $crud->getData("SELECT * FROM school_holidays WHERE 	srno = '$id' Limit 1");
		...
		?>		
          ...
          <form action="crud/updateaddholidays.php" enctype="multipart/form-data" method="post">
		...
		<div class="container-fluid form-group"><!-- Row 4 -->
			...
			<div class="col-lg-6" id="userFormColumn7">
				...
				<div class="form-group">
					<div class="col-sm-3"><label for="class">Holidays Occasion</label></div>
					<div class="col-sm-6">
					
					<input type="text" name="occasion" required class='form-control detail' placeholder="Enter Holidays Occasion" value="<?php echo $occasion;?>">
					</div>
			...
			<div class="col-lg-6" id="userFormColumn8">
				...
				<div class="form-group">
				   <div class="col-sm-3"> <label for="Gender">Holidays Details</label></div>
					<div class="col-sm-6">
									
					<input type="text" name="details" class='form-control detail' placeholder="Enter Holidays Details" value="<?php echo $details;?>">
		...
		<div class="container-fluid form-group"><!-- Row Last -->
			...
			<div class="col-lg-12" id="studentSubmit">
				...
				<div class="form-group">
					...
					<div class="col-sm-4"><input type="submit"  value="Submit" name="SubmitUpdateHolidays" class="btn btn-primary" /></div>
		...
		$query = "Select * from school_holidays ORDER BY srno Asc";
		
		$rows = $crud->getNorows($query); 
		
		
		$result = $crud->getData("SELECT * FROM school_holidays  ORDER BY srno Asc Limit $start, $perpage");
		...
		<th style="border: 1px solid #FFFFFF;background: #3c8dbc;color: #FFFFFF;text-align: center; ">Occasion</th> 
		<th style="border: 1px solid #FFFFFF;background: #3c8dbc;color: #FFFFFF;text-align: center; ">Details</th>
		...
		<th style="border: 1px solid #FFFFFF;background: #3c8dbc;color: #FFFFFF;text-align: center; ">Delete</th>
			...
			foreach ($result as $res) {
				...
				echo '<td style="padding: 1px;border: 1PX solid #FFFFFF;background: #B0C4DE ;">' . $occasion . '</td>';
				echo '<td style="padding: 1px;border: 1PX solid #FFFFFF;background: #B0C4DE ;">' . $details . '</td>';
				
				echo '<td style="padding: 1px;border: 1PX solid #FFFFFF;background: #B0C4DE; text-align:center;"><a align href="updateholidays.php?id=' . $id . '">Update</a></td>'; 
				
				echo '<td style="padding: 1px;border: 1PX solid #FFFFFF;background: #B0C4DE; text-align:center;"><a align href="crud/deleteholidays.php?id=' . $id . '" onclick="return confirmDelete()">Delete</a></td>';	
                echo "</tr>"; 
		...
		$query = "Select count(*) As Total from school_holidays ";
		...
		$result = mysqli_query($conn, "Select count(*) As Total from school_holidays");
		...
		echo "<span><a id='page_a_link' href='createaholidays.php?page=$j'>&nbsp;&nbsp;< Prev&nbsp;&nbsp;</a></span>";
		...
		echo "<span><a id='page_a_link' href='createaholidays.php?page=$i'>&nbsp;&nbsp;$i&nbsp;&nbsp;</a></span>";
		...
		echo "<span><a id='page_a_link' href='createaholidays.php?page=$j'>&nbsp;&nbsp;Next >&nbsp;&nbsp;</a></span>";
